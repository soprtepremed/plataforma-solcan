...
ADD COLUMN IF NOT EXISTS categoria TEXT DEFAULT 'Consumibles';

COMMENT ON COLUMN materiales_catalogo.categoria IS 'Categoría del material: Reactivos, Consumibles, Equipos, etc.';
`;

async function runMigration() {
  console.log('🚀 Añadiendo columna "categoria" a materiales_catalogo...');
